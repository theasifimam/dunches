      ...
      >
          ...
          >
            ...
            <div className="space-y-4">
              <span className="inline-flex items-center gap-1.5 bg-primary/15 text-primary px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-wider">
                <Sparkles className="w-3 h-3 fill-primary/10" /> manifest statement
              </span>
        ...
        >
          ...
          <div className="space-y-4 text-sm text-foreground/60 leading-relaxed font-light">
            <p>
              It started during late-night coding sessions. Our founder, Ayaan, was tired of choosing between greasy, chemical-heavy potato chips that left him sluggish, or tasteless cardboard-like health bars that failed to satisfy his fiery cravings.
            </p>
            <p>
              He realized that snacking shouldn&apos;t be a compromise between flavor and wellness. His journey led him to the pristine wetlands of the Himalayas, where he rediscovered the ancient superfood: <strong>Makhana (Lotus Seeds)</strong>. Slow-roasted to lock in the ultimate crunch, and tossed in bold, handcrafted spice blends, Dunches was born.
            </p>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-xs text-foreground/50 leading-relaxed font-light">
              100% organic Himalayan Lotus Seeds, hand-harvested from natural wetlands. No compromises, no cheap fillers.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-xs text-foreground/50 leading-relaxed font-light">
              Tossed in cold-pressed oils, natural herbs, and premium spice blends. No artificial powders or MSG.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-xs text-foreground/50 leading-relaxed font-light">
              Baked through slow heat cycles to lock in maximum structural crunch. Never deep-fried, always airy.
            </p>
          </motion.div>
        </div>
        ...
        <motion.div
          variants={itemVariants}
          className="p-8 sm:p-10 rounded-[3rem] border border-border/50 bg-foreground/2 backdrop-blur-xl space-y-8"
        >
          <div className="flex items-center gap-3">
            <User className="w-5 h-5 text-primary" />
            <h2 className="text-xl font-bold font-serif text-foreground">Meet the Creator</h2>
          </div>

          <div className="flex flex-col sm:flex-row gap-8 items-center sm:items-start">
            <div className="relative group shrink-0">
              <div className="absolute inset-0 bg-primary/20 rounded-3xl blur-md group-hover:scale-105 transition-transform" />
              <div className="w-24 h-24 rounded-3xl bg-primary/10 border border-primary/20 flex items-center justify-center rotate-6 hover:rotate-0 transition-transform duration-500 relative z-10 bg-background overflow-hidden">
                <Flame className="w-12 h-12 text-primary animate-pulse fill-primary/5" />
              </div>
            </div>
            ...
            <div className="space-y-4 text-center sm:text-left flex-1">
              <div>
                ...
                <p className="text-[10px] uppercase tracking-widest text-primary font-black mt-0.5">
                  Founder & Chief Craving Officer
                </p>
              </div>
              <p className="text-xs text-foreground/60 leading-relaxed font-light">
                &ldquo;Dunches was born out of personal necessity. As a developer, night owl, and health-conscious snacker, I wanted something that would keep me sharp without sacrificing on fiery flavor. We built Dunches for creators, thinkers, and anyone who refuses to settle for boring snacks.&rdquo;
              </p>
              <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 pt-1 text-[10px] text-foreground/45 font-bold uppercase tracking-widest">
                <span className="flex items-center gap-1.5">
                  <Coffee className="w-3.5 h-3.5 text-primary" /> Coded in Himalayas
                </span>
                <span className="text-foreground/15 hidden sm:inline">&bull;</span>
                <span className="flex items-center gap-1.5">
                  <Heart className="w-3.5 h-3.5 text-red-500 fill-red-500/10" /> Crafted for Night Owls
                </span>
              </div>
            </div>
          </div>
