...
export default function SecurityPage() {
    return (<div className="space-y-6 md:space-y-12 pb-10">
            <PageHeader badgeIcon={Shield} badgeText="Security Citadel" titleMain="Security" titleAccent="Fortress" description="Hardening the digital perimeter. Managed encrypted protocols and multi-factor authentication nodes." actionIcon={Key} actionLabel="Lockdown Parameters" onAction={() => console.log('Activating lockdown Activating lockdown...')}/>
            ...
            <div className="mx-auto space-y-6 md:space-y-10 px-0">
                <div className="p-4 md:p-10 rounded-2xl md:rounded-[3.5rem] bg-card border shadow-sm border-primary/5 space-y-6 md:space-y-10 group/section">
                    ...
                    <div className="space-y-4 md:space-y-6 pt-2 md:pt-4">
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 md:p-8 rounded-xl md:rounded-[2rem] bg-muted/10 border-2 border-dashed border-primary/10 hover:border-primary/40 hover:bg-primary/[0.02] transition-all cursor-pointer group/item gap-4 md:gap-6">
