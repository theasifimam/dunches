      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            exit={{ opacity: 0 }}
            onClick={onClose}
            className="fixed inset-0 bg-black/60 z-2000 cursor-pointer backdrop-blur-xs"
          />
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 max-w-md mx-auto bg-card border-t border-border/30 rounded-t-[2rem] p-6 shadow-2xl z-2001 flex flex-col focus:outline-none pb-10 overflow-hidden select-none"
          >
            ...
            <button
              onClick={onClose}
              className="absolute top-4 right-5 p-1.5 rounded-full text-foreground/35 hover:text-foreground hover:bg-foreground/5 transition-all cursor-pointer z-10"
